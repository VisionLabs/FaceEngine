...
print(fe.PyIFaceEngine.createHumanWarper.__doc__)
...
print(fe.IHumanWarperPtr.__doc__)
print(fe.IHumanWarperPtr.warp.__doc__)

print(fe.IDescriptorPtr.__doc__)
print(fe.IDescriptorPtr.getModelVersion.__doc__)
print(fe.IDescriptorPtr.getDescriptorType.__doc__)
...
print(fe.IDescriptorBatchPtr.getDescriptorType.__doc__)
print(fe.IDescriptorBatchPtr.getDescriptorLength.__doc__)
...
print(fe.SubjectiveQuality.isGood.__doc__)
