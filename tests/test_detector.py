...
class TestFaceEngineDetector(unittest.TestCase):
    ...
    def testHumanDetector(self):
        ...
        self.assertEqual(392, list_of_list_of_detections[0][0].detection.rect.x)
        self.assertEqual(223, list_of_list_of_detections[0][0].detection.rect.y)
        self.assertEqual(107, list_of_list_of_detections[0][0].detection.rect.width)
        self.assertEqual(269, list_of_list_of_detections[0][0].detection.rect.height)
